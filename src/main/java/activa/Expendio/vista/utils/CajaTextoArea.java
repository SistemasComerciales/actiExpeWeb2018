...
public class CajaTextoArea extends JTextArea {
    ...
    /**
     * N = Solo numero Entero D = Numero decimal y entero L = Solo letras G =
     * Letras y Numeros F = Fecha M = Moneda P = Porcentaje
     *
     */
    private String tipo;
    public int longitudMaxima = 500;

    /**
     * @param tipo
     * @param longitudMaxima Contructor N = Solo numero Entero D = Numero
