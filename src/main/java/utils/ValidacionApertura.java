...
/**
 * Link para ejecutar unica aplicacion:
 * http://www.jc-mouse.net/java/evitar-ejecutar-un-programa-java-mas-de-una-vez
 *
 * @web http://www.jc-mouse.net
 * @author Mouse
 */
public class ValidacionApertura {

    private static ValidacionApertura control = null;
     ...
     * @return
     */
    public static ValidacionApertura getInstance(String rutaProyecto) {
        if (control == null) {
            control = new ValidacionApertura(rutaProyecto);
        }
        return control;
    }
     ...
     * @param rutaProyecto
     */
    private ValidacionApertura(String rutaProyecto) {
